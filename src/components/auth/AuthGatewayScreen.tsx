...
export const AuthGatewayScreen: React.FC = () => {
  ...
  // Mandatory initial screen is Sign In
            ...
            <div className="space-y-5 animate-in fade-in duration-200">
              ...
              <div className="p-4 rounded-2xl bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-900 text-xs text-amber-800 dark:text-amber-200 space-y-2">
                ...
                <p className="text-[11px] leading-relaxed">
                  To protect student account data, please contact the TagSkills student support team on WhatsApp at <strong>+91 89711 64999</strong> with your registered email for identity verification and account recovery.
                </p>
              </div>
              ...
              <button
                ...
                className="w-full py-3.5 rounded-2xl bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-bold text-xs hover:bg-slate-200 transition-colors cursor-pointer"
              >
                ← Back to Sign In
              </button>
            </div>
